...
const AdminStudentAccountStatus = ({ show, student, onClose, onConfirm }) => {
  if (!show || !student) return null;

  const isDeactivating = student.tracked_Status === "Active";
        ...
        <div className="text-center">
          ...
          <div className="mt-4 mb-6">
            <p className="text-sm text-gray-600 mb-3">
              Are you sure you want to {action.toLowerCase()} this student account?
            </p>
            <div className="bg-gray-50 rounded-lg p-4 text-left">
              <p className="text-base sm:text-lg font-semibold text-gray-900 break-words">
                {student.tracked_firstname} {student.tracked_middlename} {student.tracked_lastname}
              </p>
              ...
              <p className="text-sm text-gray-600">
                Year & Section: {student.tracked_yearandsec}
              </p>
            </div>
          </div>
...
export default AdminStudentAccountStatus;