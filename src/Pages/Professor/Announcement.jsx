        ...
        <div className="p-3 sm:p-4 md:p-5 lg:p-5 xl:p-5">
          ...
          <div className="mt-3 sm:mt-4 md:mt-5">
            ...
            <div className="flex items-center justify-between gap-3 mb-3">
              ...
              {/* Add button */}
              <button className="font-bold py-2 bg-[#fff] rounded-md w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 shadow-md flex items-center justify-center hover:border-[#00874E] hover:border-2 cursor-pointer flex-shrink-0">
                <img
                  src={Add}
                  alt="Add"
